...
import MenuVertical from "./Menuvertical"; // Importa el componente MenuVertical
      ...
      <div className="main-content">
        ...
        <div className="form-container">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              <div className="form-group">
                <label htmlFor="hora">Hora de la cita (solo en intervalos de 20 minutos):</label>
                <select
                  id="hora"
                  name="hora"
                  value={formData.hora}
            ...
            <div className="form-group">
              <label htmlFor="sintomaSlider">Desliza para describir tu síntoma:</label>
              <input
                type="range"
                id="sintomaSlider"
                name="sintomaSlider"
