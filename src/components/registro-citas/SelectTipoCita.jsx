...
function SelectTipoCita({ onSelectChange = () => {}, initialValue = "" }) {
  const title = "Selecciona una opción";

  const options = {
    default: "Seleccionar",
    opcion1: "Consulta general",
    opcion2: "Consulta de especialidad",
    opcion3: "Consulta de seguimiento",
  };
